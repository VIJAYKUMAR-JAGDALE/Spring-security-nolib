...
<header>
 <h1 align="center"> Maharastra Bank</h1>
</header>
<body style="background-image: url('resources/images/img1.png'); background-size: 1500px 600px;
                  ...
                  <div class="col-xs-6">
                      <div class="well">
                         <form name='loginForm' action="<c:url value='j_spring_security_check' />" method='POST'>
                              ...
                              <a href="/forgot/" class="btn btn-info">Help to login</a>
                          </form>
                      </div>
                  </div>
                  <div class="col-xs-6">
                      ...
                      <p><a href="newcustomer" class="btn btn-info btn-block">Yes please, register now!</a></p>
                  </div>
              </div>
          </div>
      </div>
